...
<body>
  ...
  <div class="cobtainer">
    ...
    <ul class="pictureslides">
      <li><img src="../../images/iphone.jpg" alt=""></li>
      <li><img src="../../images/iPhone11.jpg" alt=""></li>
      <li><img src="../../images/iphonelots.jpg" alt=""></li>
      <li><img src="../../images/iphoneseconds.jpg" alt=""></li>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <h2>全新機</h2>
        <p>這裡賣的是全新機</p>
        <p><a class="btn btn-secondary" href="https://getbootstrap.com/docs/4.5/examples/carousel/#" role="button">點此前往
            »</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg"
  ...
  <div id="gtx-trans" style="position: absolute; left: 1193px; top: 286px;">
