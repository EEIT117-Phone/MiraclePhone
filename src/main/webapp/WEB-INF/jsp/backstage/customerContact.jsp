...
<div id="content">
  ...
  <main id="main">
  	...
  	<div class="tab-pane" id="selectq_1" role="tabpanel" aria-labelledby="list-home-list">
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=賣家相關&selectq2=賣家評價" />' aria-selected="true">賣家評價</a>
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=賣家相關&selectq2=商品付款方式" />'  aria-selected="false">商品付款方式</a>
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=賣家相關&selectq2=商品規格疑問" />' aria-selected="false">商品規格疑問</a>
  	...
  	<div class="tab-pane" id="selectq_2" role="tabpanel" aria-labelledby="list-home-list">
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=配送問題&selectq2=配送時長" />' aria-selected="true">配送時長</a>
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=配送問題&selectq2=配送方式" />' aria-selected="false">配送方式</a>
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=配送問題&selectq2=其他" />' aria-selected="false">其他</a>
...
<!-- 				<a class="nav-link" data-toggle="tab" href="/MiraclePhone/backstage/customerContact?selectq2=其他"  role="tab" aria-selected="false">其他</a> -->
  	...
  	<div class="tab-pane" id="selectq_3" role="tabpanel" aria-labelledby="list-home-list">
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=會員相關&selectq2=修改會員資料" />' aria-selected="true">修改會員資料</a>
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=會員相關&selectq2=海外會員" />' aria-selected="false">海外會員</a>
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=會員相關&selectq2=取消註冊" />' aria-selected="false">取消註冊</a>
...
<!-- 				<a class="nav-link" data-toggle="tab" href="/MiraclePhone/backstage/customerContact?selectq2=取消註冊"  role="tab" aria-selected="false">取消註冊</a> -->
  	...
  	<div class="tab-pane" id="selectq_4" role="tabpanel" aria-labelledby="list-home-list">
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=退貨及退款&selectq2=退貨進度查詢" />' aria-selected="true">退貨進度查詢</a>
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=退貨及退款&selectq2=退貨相關問題" />' aria-selected="false">退貨相關問題</a>
				<a class="nav-link" href='<c:url value="/backstage/customerContact?selectq1=退貨及退款&selectq2=維修保固相關問題" />' aria-selected="false">維修保固相關問題</a>
