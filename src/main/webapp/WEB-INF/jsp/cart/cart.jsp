                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="cart-delete btn btn-secondary btn-sm"
                                    id="deleteOrder">刪除</button>
                            </td>
                        </tr>
                </c:forEach>
                </tbody>
            ...
            <table class="cart-summary table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>總金額:$</td>
                        <td>
                            <a href="shipInfo.heml" class="btn btn-primary btn-sm" role="button"
                                aria-pressed="true">送出訂單</a>
                        </td>
                    </tr>
                </tbody>
            </table>
