            ...
            <div class="col-4" style="position: relative; left:-250px;">
                <div class="list-group" id="list-tab" role="tablist">
                    <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list"
                        href="#list-home" role="tab" aria-controls="home">常見問題</a>
                    <a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list"
                        href="#list-profile" role="tab" aria-controls="profile">客服留言</a>
                    <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list"
                        href="#list-settings" role="tab" aria-controls="settings">會員權益聲明</a>
                    <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list"
                        href="#list-messages" role="tab" aria-controls="messages">修改密碼</a>
                </div>
            </div>
            <div class="row">
                <div class="col-8" style="margin: 0 auto;margin-top: -180px;">
                    <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="card-body">
                                            <b>為何沒有收到發票?</b><br>
                                            根據財政部令 台財資字第 1070001765 號 「電子發票實施作業要點」，自 103 年 1 月 1
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                        ...
                                        <div class="card-body">
                                            <b>我的折價劵</b><br>
                                            進入『我的帳戶>我的折價劵』，可以查詢折價劵或輸入折價劵號。<br><br>
                                            <b>如何使用折價劵</b><br>
                                            在結帳時，點選使用折價券或填入折價券折扣碼，就可以享有優惠喔！<br><br>
                                            <b>折價劵使用規則</b><br>
                                            1. 每次線上結帳，只能使用一張折價券，門市及櫃點使用則以另行公告為主。<br>
                                            2. 使用折價券折抵後，每項商品金額不可為零。<br>
                                            3. 若結帳商品標註為「不適用折價券」，則該商品不能使用折價券進行折抵。<br>
                                            4. 折價券僅能使用一次且不找零，一經使用無法恢復。<br>
                                            5. 使用折價券的訂單如取消或退貨，折價券將自動失效不會歸還。<br>
                                            6. 折價券有使用效期，逾期後則無法使用，且無法恢復。<br>
                                            7. 折價券不可折抵運費。，務必依退貨退款頁面，填寫正確的退款帳號資料。商店確認商品退貨完成後，
                        ...
                        <div class="tab-pane fade" id="list-profile" role="tabpanel"
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                        aria-controls="home" aria-selected="true">客服留言</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                        aria-controls="profile" aria-selected="false">問答紀錄</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <b>問題類別:</b><br><br>
                                    <div>
                                        <select id="question" onchange="changequestion(this.selectedIndex)" class="bot"
                        ...
                        <div class="tab-pane fade" id="list-settings" role="tabpanel"
                            ...
                            收到商品後可享有7天免費鑑賞期(含例假日)，鑑賞期係供您參考、觀賞、品鑑比較，如需要辦理退/換貨，請於到貨後7天內登錄「我的帳戶」頁面申請「退/換貨」，我們將盡速為您處理。<br><br>
                            <b>退貨方式：</b><br>
                            自收到商品日起，退貨方式建議採用「面交」，以保證機身無任何損毀，面交當下請確認商品有無損毀，否則一概不負任何責任。<br><br>
                            <b>退貨注意事項：</b><br>
                            退貨的商品必須回復原狀，亦即必須回復至您收到商品時的原始狀態 ( 包含機台本身、附件、內外包裝、活動贈品等 )，若您已取得紙本發票，請於退貨時一併退還。<br>
                            ...
                            如連續退貨3次或6個月內退貨達5次，官網將限制下單3個月，主要是希望門市人員能協助您挑選到適合的商品，以免您花費太長的時間確買不到適合您的商品。<br><br>
                            <b>下列情形可能影響您的退貨權限：</b><br>
                            在不影響您檢查商品情形下，您將商品包裝毀損、封條移除、貼膠移除或標籤拆除等情形，在您收到商品之前，已提供您檢查商品之機會。<br>
                            其他逾越檢查之必要或可歸責於您之事由，致商品有毀損、滅失或變更者。<br><br>
                            <b>海外地區：</b><br>
                            ...
                            退貨請自行寄回台灣，並且需要自行付擔運費，退貨的商品必須必須回復原狀，亦即必須回復至您收到商品時的原始狀態 ( 包含機台本身、附件、內外包裝、活動贈品等 )
                            請您以送貨廠商使用之包裝紙箱將退貨商品包裝妥當，若原紙箱已遺失，請另使用其他紙箱包覆於商品原廠包裝之外，切勿直接於原廠包裝上黏貼紙張或書寫文字，若原廠包裝損毀將無法退貨或須將損壞費用於退款中扣抵。<br>
