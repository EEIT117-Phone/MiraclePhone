	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8 order-md-1">
				...
				<form id="userdata" action="/MiraclePhone/usersignup" method="post"
					onsubmit="checkform()" enctype="multipart/form-data">
					<div class="row">
					...
					<div class="mb-3">
						...
						<div class="input-group">
							...
							<input type="email" class="form-control" id="account"
								name="account" placeholder="請輸入電子信箱" value="${useraccount}"
								required> <input type="hidden" id="status" name="status"
								value="${vertifimail}">
						</div>
						<div style="padding-top: 5px">
							<button id="vertifyacc" class="btn btn-primary" type="button"
								name="vertifyacc">寄送驗證信</button>
					...
					<div class="d-block my-3">
						...
						<div class="custom-control custom-radio">
							<input type="radio" id="other" name="sex"
								class="custom-control-input" value="other"> <label
								class="custom-control-label" for="other">其他</label>
						</div>
					</div>
					<h4 class="mb-3">上傳大頭貼</h4>
					<div class="d-block my-3">
						<input type="file" accept="image/*" id="file" name="file">
						<img id="previewImg" name="previewImg"
							style="weight: 100px; height: 100px" src="">

					</div>
					<div class="mb-3">
						<h4>賣家權限</h4>
						<input type="radio" id="seller" name="seller" value="seller">
						<span id="seller_word">是否成為賣家</span><br> <input type="radio"
							id="shipInfoFace" name="shipInfoFace" value="商品面交"><span
							id="shipInfoFace_word">商品可面交</span> <input type="radio"
							id="shipInfoPost" name="shipInfoPost" value="商品郵寄匯款"><span
							id="shipInfoFace_word">商品可郵寄匯款</span>
					</div>
					...
					<div class="mb-3">
						...
						<input id="bankaccount" type="text" name="bankaccount"
							...
							value="" placeholder="請輸入數字" required>
					</div>

					<button class="btn btn-primary btn-lg btn-block" type="submit"
						id="send" name="send">提交</button>
				</form>
			</div>
		</div>
