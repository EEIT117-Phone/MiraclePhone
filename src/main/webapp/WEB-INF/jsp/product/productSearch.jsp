...
<%-- 	<form:hidden path="productId" /> --%>
					<td>
					 <input type="number" max="50000" min="0" value=${result.amount} step="100" required="required"
                    name="amount" /></td>
					<td><textarea  rows="1" cols="17" maxlength="110" name=sellReason >${result.sellReason}</textarea>
					<input type="submit" class="btn btn-primary" value="儲存"/></td>
					</form:form>
				</tr>
			</c:forEach>
		</tbody>
